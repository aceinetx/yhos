...
BINS=build/yhos.img build/kernel_entry.o build/kernel.o build/void.bin build/boot.bin build/lowlevel.o build/syscall.o build/keyboard.o
...
build/yhos.img: $(BINS)
	$(dir_guard)
	i386-elf-ld -o build/kernel.bin -Ttext 0x1000 build/kernel_entry.o build/kernel.o build/lowlevel.o build/syscall.o build/keyboard.o --oformat binary
...
build/kernel.o: kernel/kernel.c kernel/syscall.h kernel/types.h kernel/keyboard.h
	$(dir_guard)
